 ...
 * @description 自定义RecyclerView动画，拷贝BaseItemAnimator按图索骥
 */
public class CustomAnimator extends SimpleItemAnimator {
    ...
    public CustomAnimator(float recyclerViewHight, float miskHeight) {
        super();
    ...
    public void runPendingAnimations() {
        ...
        if (movesPending) {
            ...
            if (removalsPending) {
                ...
                //由于是缓慢上浮动画，延迟300ms使与add动画平滑衔接
                ViewCompat.postOnAnimationDelayed(view, mover, getRemoveDuration() + 300);
            }
        }
...
//                long moveDuration = movesPending ? getMoveDuration() : 0;
    ...
    protected void animateAddImpl(final RecyclerView.ViewHolder holder) {
        Log.d(TAG, "animateAddImpl: " + System.currentTimeMillis());
        //执行添加动画
        holder.itemView.animate()
...
//                .rotation(360)//旋转360度
    ...
    private void animateMoveImpl(final ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        Log.d(TAG, "animateMoveImpl: " + System.currentTimeMillis());
        final View view = holder.itemView;
        ...
        animation.setDuration(getMoveDuration()).setListener(new VpaListenerAdapter() {
            ...
            public void onAnimationEnd(View view) {
                Log.d(TAG, "animateMove End: " + System.currentTimeMillis());
